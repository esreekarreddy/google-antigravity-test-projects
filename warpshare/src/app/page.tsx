  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative z-10">
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl font-display font-bold text-transparent bg-clip-text bg-linear-to-br from-white via-white to-white/50 mb-4 tracking-tight">
          ZapShare
        </h1>
        <p className="text-lg text-slate-400 max-w-lg mx-auto leading-relaxed">
          Secure, peer-to-peer file transfer at <span className="text-primary font-bold">lightspeed</span>.
          <br/>No cloud storage. No file limits.
        </p>
      </motion.div>
