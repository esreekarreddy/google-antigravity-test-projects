...
export const metadata: Metadata = {
  ...
  keywords: ["Sreekar Reddy", "Sreekar Edulapalli", "sreekarreddy.com", "Sreekar Reddy portfolio", "Sreekar Reddy todo", "Sreekar Reddy task manager", "Sreekar Reddy projects", "minimal todo app", "simple task manager", "free todo list"],
  authors: [{ name: "Sreekar Reddy", url: "https://sreekarreddy.com" }],
  creator: "Sreekar Reddy",
  publisher: "Sreekar Reddy",
  metadataBase: new URL("https://sreekarreddy.com/projects/todo"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
    type: "website",
    url: "https://sreekarreddy.com/projects/todo",
