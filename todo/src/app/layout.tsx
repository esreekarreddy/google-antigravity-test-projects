...
export const metadata: Metadata = {
  ...
  keywords: ["Sreekar Reddy todo", "Sreekar Reddy task manager", "Sreekar Reddy projects", "Sreekar Edulapalli", "sreekarreddy.com", "Sreekar Reddy portfolio", "minimal todo app", "simple task manager", "free todo list"],
